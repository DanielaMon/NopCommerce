-- 1. Add column Author to Product and ProductAttributeCombination
ALTER TABLE Product ADD Author nvarchar(400) NULL
GO

ALTER TABLE ProductAttributeCombination ADD Author nvarchar(400) NULL
GO


-- 2. Alter StoredProcedure [dbo].[ProductLoadAllPaged] to include Author in keyword search 
/****** Object:  StoredProcedure [dbo].[ProductLoadAllPaged]    Script Date: 12/06/2018 21:28:45 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	@SearchAuthor bit = 0, -- a value indicating whether to search by a specified "keyword" in author
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			WHERE '
			IF @UseFullTextSearch = 1
				SET @sql = @sql + ' CONTAINS(p.[Author], @OriginalKeywords) '
			ELSE
				SET @sql = @sql + ' PATINDEX(@Keywords, p.[Author]) > 0 '
		END
...
-- 3. Update LocaleStringResource to include the text to display for Author (this will need to be done for each supported language) 
INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.Author','Author')
GO
INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.Author.Hint','The author for this attribute combination.')
GO

INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Catalog.Products.Fields.Author','Author')
GO
INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Catalog.Products.Fields.Author.Hint','The author for this product.')
GO

INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Configuration.Settings.Catalog.ShowAuthor','Show author')
GO
INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Configuration.Settings.Catalog.ShowAuthor.Hint','Check to show author in public store.')
GO
...
INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Admin.Configuration.Settings.ProductEditor.Author','Author')
GO

INSERT INTO [dbo].[LocaleStringResource] ([LanguageId],[ResourceName],[ResourceValue]) VALUES (1,'Products.Author','Author')
GO
