...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// <param name="searchAuthor">A value indicating whether to search by a specified "keyword" in author</param>      
            ...
            bool? overridePublished = null)
        {
            ...
            return SearchProducts(out IList<int> _, false,
                ...
                searchAuthor, searchProductTags, languageId, filteredSpecs,
