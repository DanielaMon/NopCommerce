...
namespace Nop.Services.Catalog
{
    ...
    public static class ProductExtensions
    {
        ...
        public static string FormatSku(this Product product, string attributesXml = null, IProductAttributeParser productAttributeParser = null)
        {
            ...
            product.GetSkuMpnGtin(attributesXml, productAttributeParser, out string sku, out string _, out string _, out string _);
        ...
        public static string FormatMpn(this Product product, string attributesXml = null, IProductAttributeParser productAttributeParser = null)
        {
            ...
            product.GetSkuMpnGtin(attributesXml, productAttributeParser, out string _, out string manufacturerPartNumber, out string _, out string _);
        ...
        /// <param name="productAttributeParser">Product attribute service (used when attributes are specified)</param>
        /// <returns>Manufacturer part number</returns>
        public static string FormatAuthor(this Product product, string attributesXml = null, IProductAttributeParser productAttributeParser = null)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            product.GetSkuMpnGtin(attributesXml, productAttributeParser, out string _, out string _,  out string author, out string _);
        ...
        public static string FormatGtin(this Product product, string attributesXml = null, IProductAttributeParser productAttributeParser = null)
        {
            ...
            product.GetSkuMpnGtin(attributesXml, productAttributeParser, out string _, out string _, out string _, out string gtin);
